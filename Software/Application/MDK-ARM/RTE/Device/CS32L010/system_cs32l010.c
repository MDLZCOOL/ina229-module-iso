/**
  ...
  *      - SystemInit(): Setups the system clock (System clock source, AHB/APB 
	...
	*											 is made inside the "startup_cs32l010_xx.s" file.
  *                      
  ...
  *    Then SystemInit() function is called, in "startup_cs32l010_xx.s" file, to
...
/** @addtogroup CS32L010_System_Private_Includes
  * @{
  */
#include "cs32l010.h"
...
/** @addtogroup CS32L010_System_Private_Defines
  * @{
  */
...
/** @addtogroup CS32L010_System_Private_Variables
  * @{
  */
...
/** @addtogroup CS32L010_System_Private_Functions
  * @{
  */
...
/**
  ...
  *         
  *         (*) HIRC_VALUE_xxM is a constant defined in cs32l010_hal_conf.h file (default value
  *             4 MHz) but the real value may vary depending on the variations
  *             in voltage and temperature.   
  *    
  *         (**) HXT_VALUE is a constant defined in cs32l010_hal_conf.h file (default value
